...
{
	realft(data - 1, n, isign); // Have to offset array for crappy numerical recipies style arrays.
}
...
{
	InitTable(Forward1024, MAX_FFT_SIZE, 1);
	InitTable(Reverse1024, MAX_FFT_SIZE, -1);
}
