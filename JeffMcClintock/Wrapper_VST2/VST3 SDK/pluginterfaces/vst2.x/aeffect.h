...
#ifndef VST_FORCE_DEPRECATED
#define VST_FORCE_DEPRECATED 0 //was defined as VST_2_4_EXTENSIONS. Cubase 3.x did not send MIDI events to the plugin. The reason is that Cubase 3.x was built with VST SDK 2.3. There, you must call the deprecated function wantEvents(), if you want your plugin to receive MIDI events.
#endif
